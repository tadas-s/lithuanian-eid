...
![Žinutė](doc/lteid-toolbox-notification.png)

Spustelėjus tą žinutę atsidarys langas įvesti kortelės prieigos kodą:

![Kortelės prieigos kodas](doc/lteid-toolbox-can-entry.png)

Įvedus kodą:

![Kortelės prieigos kodas](doc/lteid-toolbox-ready.png)
...
![epaslaugos.lt login](doc/epaslaugos-login-1.png)

Tada paspaudus "Prisijungti":

![epaslaugos.lt login](doc/epaslaugos-login-2.png)

Iššoka PIN kodo langas:

![epaslaugos.lt login](doc/epaslaugos-login-pin.png)
